...
function audio(audioURL) {
    //This variable creates a new audio object and passes the path as a parameter.
    let audio = new Audio(audioURL);
    //This method plays our audio sound.
    audio.play();
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y2 = coordY2,
        //This variable stores the gradient color of the win line.
        x = x1,
        ...
        function animateLineDrawing() {
            ...
            c.stroke();
            //This condition checks if we've reached the x endpoint.
            if (x1 <= x2 && y1 <= y2) {
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variable accesses the HTML element i.
        let square = document.getElementById(String(i));
        //This removes the background image from each square.
        square.style.backgroundImage = '';
    }
    //This resets the selectedSquares array so it is empty and ready for a new game.
    selectedSquares = [];
}